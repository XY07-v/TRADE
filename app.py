...
# --- RUTAS DE NAVEGACIÓN (Coinciden con tus pestañas) ---
...
def filtrar_historial():
    ...
    return jsonify(list(visitas_col.find(query, {"_id": 0}).sort("fecha", -1).limit(100)))
...
def descargar():
    ...
    # Quitamos fotos para que el Excel no sea gigante
